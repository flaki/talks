...
<details>
  All these (Nodebots, Tessel) needed Node.js, and Node needed powerful hardware (Raspberry-Pi-level)
</details>
...
<details>
  The Tessel promised to bring Node.js to the hardware, running JS & Node on something much "closer-to-the-metal" than a Raspberry Pi.
</details>
...
<details>
  If you are curious how & why that didn't <em>exactly</em> pan out, watch Jon McKay's Tessel retrospective - if you have, or thinking on starting a startup, esp. hardware startup, this is a must-watch for you. But the writing was already on the wall...
</details>
...
<details>
  ...everybody wanted JavaScript to run on embedded hardware.
</details>
...
<details>
  Why? This guy, Jan Jongboom can give you multiple reasons why running a JS VM on constrained hardware is not only not an awful idea, but it even makes actual sense (watch the video).

  But at the end of the day, the answer is even more simple than that...
</details>
...
<details>
  Now we'll get back to this point later, but basically JavaScript's ubiquity and ease-of-use led to people wanting to be able to develop in JS for literally and exhaustively <em>everything</em>.
</details>
